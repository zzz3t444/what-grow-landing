...
<template>
  <div class="py-6">
    <div class="container mx-auto flex flex-col justify-center mt-20 p-4 space-y-8 md:p-10 lg:space-y-0 lg:space-x-12 lg:justify-evenly lg:flex-row">
      ...
      <div class="flex flex-row items-center self-center justify-center flex-shrink-0 shadow-md lg:justify-end">
        <div class="flex flex-row">
          <input type="text" placeholder="yourmail@gmail.com" class="w-3/5 p-3 rounded-l-lg sm:w-2/3" v-model="email" />
          <button type="button" class="w-2/5 p-3 font-semibold hover:scale-95 duration-100 transition-all rounded-r-lg sm:w-1/3 dark:bg-lime-500 dark:text-gray-50" @click="subscribe">
            Subscribe
          </button>
        </div>
      </div>
