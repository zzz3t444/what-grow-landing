...
<template>
  <section class="hero text-center py-16 mt-20">
    <div class="container mx-auto">
      <div>
        <h1 class="text-3xl md:text-5xl text-neutral-400 font-normal mb-1 Manrope">
          Fast, Collaborative, AI-Native
        </h1>
        <p class="text-4xl md:text-5xl Manrope text-neutral-100 font-normal mb-3 lg:mb-5">
          Content Management
        </p>
      ...
      <div class="flex flex-wrap justify-center gap-10 opacity-40 scale-75 mb-8 ">
        <img
      ...
      <button
        class="bg-orange-500 hover:shadow-2xl hover:shadow-neutral-400 text-white font-medium Roboto hover:text-neutral-100 hover:scale-95 transition-all duration-150 text-sm py-2 px-4 rounded-full"
      >
        Get Started
      </button>
    </div>
